...
import { aceitarConviteWebmasterAction, type EstadoConviteWebmaster } from "./actions";

const ESTADO_INICIAL: EstadoConviteWebmaster = {};

export function FormAceitarConvite({ token }: { token: string }) {
  const [estado, formAction, pending] = useActionState(aceitarConviteWebmasterAction, ESTADO_INICIAL);
