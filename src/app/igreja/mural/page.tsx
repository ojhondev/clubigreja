...
export default async function MuralIgrejaPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Mural da igreja"
        subtitle="O que você publicar aqui aparece na tela inicial do fiel."
      />

      <Card className="mb-8">
        <h2 className="mb-4 font-bold">Novo comunicado</h2>
        <form
          action={publicarComunicado}
        ...
        >
          <label className="flex flex-col gap-1">
            ...
            <input
              name="emoji"
              defaultValue="📣"
              className="rounded-xl border border-border px-4 py-3 text-center text-xl"
            />
          </label>
          <label className="flex flex-col gap-1">
