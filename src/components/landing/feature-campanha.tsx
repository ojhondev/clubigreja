...
export async function FeatureCampanha() {
  const qrDataUrl = await gerarQrCodeDataUrl("https://dclubigreja.com/novavida");
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div className="order-2 flex justify-center lg:order-1">
          <Card className="relative flex flex-col items-center gap-4 px-10 py-10">
            ...
            <img src={qrDataUrl} alt="QR Code de exemplo de uma campanha" className="h-48 w-48" />
            <p className="text-sm font-bold text-muted">dclubigreja.com/novavida</p>
