...
export function Denominacoes() {
  return (
    <section id="denominacoes" className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div id="catolicas" className="scroll-mt-24 rounded-3xl border border-border bg-white p-8">
          <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#EAF6FF] text-primary">
            <Church size={26} />
          </span>
          <p className="font-display mt-6 text-2xl font-bold text-foreground">Igrejas Católicas</p>
        ...
        <div id="evangelicas" className="scroll-mt-24 rounded-3xl border border-border bg-white p-8">
          <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#EAF6FF] text-primary">
            <Heart size={26} />
          </span>
          <p className="font-display mt-6 text-2xl font-bold text-foreground">Igrejas Evangélicas</p>
          <p className="mt-2 text-muted">Igrejas locais, células e ministérios.</p>
          <ul className="mt-6 space-y-3">
