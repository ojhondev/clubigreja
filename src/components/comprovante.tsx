...
export async function Comprovante({
  ...
  if (contribuicao.status !== "confirmado")
    redirect(`${caminhoPagarBase}/${contribuicaoId}`);
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <Card className="mt-6 w-full text-left">
        ...
        <p className="mb-4 text-3xl font-bold text-success">
        ...
        <dl className="space-y-2 border-t border-border pt-4 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <dd className="font-medium">
              {formatarMoeda(contribuicao.taxaValor)}
            </dd>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between border-t border-border pt-2">
            ...
            <dd className="font-bold">
              {formatarMoeda(contribuicao.valorTotalFiel)}
            </dd>
          </div>
          <div className="flex justify-between">
            <dt className="text-muted">Data</dt>
            <dd className="font-medium">
              {formatarData(contribuicao.criadaEm)}
            </dd>
          </div>
          <div className="flex justify-between">
      ...
      <p className="mt-4 text-xs text-muted">
        A igreja recebeu o valor integral da sua contribuição — a taxa de
        processamento é paga por você, à parte.
      </p>
    </div>
  );
}
