  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <BarChart data={dados} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
        ...
        <Bar dataKey="Dízimo" stackId="a" fill="#002991" radius={[0, 0, 0, 0]} />
        <Bar dataKey="Campanha" stackId="a" fill="#60cdff" radius={[0, 0, 0, 0]} />
        <Bar dataKey="Outros" stackId="a" fill="#c7cfe0" radius={[4, 4, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
