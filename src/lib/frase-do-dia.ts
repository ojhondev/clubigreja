...
const VERSICULOS: Versiculo[] = [
  ...
  { texto: "Cada um contribua segundo propôs no seu coração, não com tristeza ou por necessidade, porque Deus ama ao que dá com alegria.", referencia: "2 Coríntios 9:7" },
  ...
  { texto: "Amai-vos uns aos outros, como eu vos amei.", referencia: "João 13:34" },
  { texto: "Sede fortes e corajosos; não temais, nem vos atemorizeis, porque o Senhor teu Deus é contigo.", referencia: "Josué 1:9" },
];
