    ...
    linksExtras: [
      {
        id: "link-extra-1",
        rotulo: "Instagram",
        url: "https://instagram.com/novavidabatista",
      },
      {
        id: "link-extra-2",
        rotulo: "Site da igreja",
        url: "https://novavida.org.br",
      },
    ],
...
export const campanhas: Campanha[] = [
  {
    ...
    descricao:
      "Reforma emergencial do telhado após as chuvas de junho — meta para concluir antes do fim do ano.",
    meta: 15000,
    prazo: "2026-10-15",
    imagemEmoji: "🔨",
    encerrada: false,
  ...
  },
  {
    ...
    descricao:
      "Apoio à equipe missionária que parte em novembro para plantar uma nova congregação.",
    meta: 8000,
    prazo: "2026-11-01",
    imagemEmoji: "✈️",
    encerrada: false,
...
export const eventos: Evento[] = [
  {
    ...
    descricao:
      "Culto especial de gratidão pelo ano, com contribuição voluntária para as missões.",
...
export const comunicadosMural: ComunicadoMural[] = [
  {
    ...
    corpo:
      "Agora você pode acompanhar tudo por aqui: mural, campanhas e sua contribuição, tudo em um só lugar.",
    emoji: "👋",
  ...
  },
  {
    ...
    corpo:
      "Já arrecadamos boa parte da meta graças à generosidade de vocês. Continue acompanhando o progresso.",
    emoji: "🙏",
  ...
  },
  {
    ...
    corpo:
      "Separe a data: 30 de agosto teremos um culto especial de gratidão. Contribuição voluntária para as missões.",
    emoji: "📅",
